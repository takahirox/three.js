...
self.originalCreateImageBitmap = self.createImageBitmap;
self.createImageBitmap = function ( blob ) {

	return self.originalCreateImageBitmap( blob );
...
function animate() {
	...
	if ( self.requestAnimationFrame ) {
		...
		self.setTimeout( animate, Math.max( 1000 / 60 - elapsedTime, 0 ) );
