...
function InterleavedBufferAttribute2( buffer, itemSize, type, normalized, stride, offset, count ) {

	this.name = '';

	this.data = buffer;
	this.array = new type( buffer.buffer, offset );
...
Object.assign( InterleavedBufferAttribute2.prototype, {
	...
	isInterleavedBufferAttribute2: true,
	...
	clone: function ( data ) {
		...
		if ( data === undefined ) {
			...
			console.log( 'THREE.InterleavedBufferAttribute2.clone(): Cloning an interlaved buffer attribute will deinterleave buffer data.' );
			...
			return new InterleavedBufferAttribute2(
	...
	toJSON: function ( data ) {
		...
		if ( data === undefined ) {
			...
			console.log( 'THREE.InterleavedBufferAttribute2.toJSON(): Serializing an interlaved buffer attribute will deinterleave buffer data.' );
...
export { InterleavedBufferAttribute2 };
